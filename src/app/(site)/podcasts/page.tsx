      ...
      <Container>
        <div className="mb-8 text-center">
          <span className="mb-2 flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-brand-light">
            <Mic2 size={14} /> {dict.listingPages.podcasts.eyebrow}
          </span>
          <h1 className="font-serif text-3xl font-extrabold sm:text-4xl">{SITE.podcastBrand}</h1>
          <p className="mx-auto mt-2 max-w-xl text-white/70">{dict.listingPages.podcasts.intro}</p>
        ...
        {!category && (
          <div className="mb-10">
            <h2 className="mb-4 text-xs font-bold uppercase tracking-widest text-white/60">{dict.home.podcastSection.featuredGuests}</h2>
        ...
        <h2 className="mb-4 text-xs font-bold uppercase tracking-widest text-white/60">{dict.common.allEpisodes}</h2>
